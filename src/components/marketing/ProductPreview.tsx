...
export default function ProductPreview() {
  return (
    <div
      className="card-shadow-lg relative max-h-[650px] overflow-hidden rounded-lg border border-slate-200 bg-card text-left"
                  ...
                  {patients.map((patient) => (
                    <div key={patient.name} className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="truncate text-xs font-bold text-slate-900">{patient.name}</p>
