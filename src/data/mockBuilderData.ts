...
export const BUILDER_STEPS: BuilderStep[] = [
  { key: 'dados_gerais',  label: 'Dados gerais',          description: 'Nome, objetivo, duração e tipo do programa' },
  ...
  { key: 'entitlements',  label: 'Entitlements do app',    description: 'Funcionalidades liberadas no app do paciente' },
...
export const mockBuilderTeamMembers: ProgramBuilderTeamMember[] = [
  ...
  { id: 'tm-002', name: 'Nutr. Carlos Mendes',   role: 'Nutricionista', specialty: 'Nutrição Clínica' },
  { id: 'tm-003', name: 'Dr. Rafael Souza',      role: 'Médico',        specialty: 'Clínica Geral' },
  { id: 'tm-004', name: 'Nutr. Beatriz Alves',   role: 'Nutricionista', specialty: 'Nutrição Esportiva' },
  { id: 'tm-005', name: 'Coord. Ana Souza',      role: 'Coordenadora',  specialty: 'Gestão de Programas' },
  { id: 'tm-006', name: 'Psic. Mariana Costa',   role: 'Psicóloga',     specialty: 'Comportamento Alimentar' },
];
...
export const initialBuilderDraft: ProgramBuilderDraft = {
  ...
  status: 'rascunho',
  phases: [
    { name: 'Fase 1 — Avaliação', durationWeeks: 2, description: 'Avaliação inicial, exames e definição de metas.' },
    { name: 'Fase 2 — Intervenção', durationWeeks: 8, description: 'Protocolo principal com acompanhamento intensivo.' },
    { name: 'Fase 3 — Consolidação', durationWeeks: 2, description: 'Revisão de resultados e planejamento de manutenção.' },
  ],
  includedServices: [
