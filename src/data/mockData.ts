...
export const mockClinicPrograms: ClinicProgram[] = [
  {
    ...
    programType: 'emagrecimento',
    objective: 'Redução de gordura corporal com preservação de massa magra, reeducação alimentar e mudança de hábitos sustentável.',
    durationWeeks: 12,
    status: 'ativo',
    color: 'teal',
    phases: [
      { name: 'Adaptação', durationWeeks: 2, description: 'Avaliação inicial, anamnese completa e ajuste metabólico.' },
      { name: 'Aceleração', durationWeeks: 6, description: 'Déficit calórico progressivo, bioimpedância quinzenal e plano alimentar ativo.' },
      { name: 'Consolidação', durationWeeks: 4, description: 'Manutenção dos resultados, ajuste de metas e preparação para alta.' },
    ],
    includedServices: [
  ...
  },
  {
    ...
    programType: 'hipertrofia',
    objective: 'Ganho de massa muscular com acompanhamento médico e nutricional especializado, periodização e suplementação orientada.',
    durationWeeks: 16,
    status: 'ativo',
    color: 'violet',
    phases: [
      { name: 'Base', durationWeeks: 4, description: 'Avaliação de composição corporal, definição de metas e ajuste calórico.' },
      { name: 'Volume', durationWeeks: 8, description: 'Superávit calórico controlado, acompanhamento de força e bioimpedância mensal.' },
      { name: 'Definição', durationWeeks: 4, description: 'Ajuste de macros, manutenção de massa e preparação para resultado final.' },
    ],
    includedServices: [
  ...
  },
  {
    ...
    programType: 'recomposicao',
    objective: 'Redução simultânea de gordura e ganho de massa magra com protocolo individualizado de nutrição e acompanhamento clínico.',
    durationWeeks: 14,
    status: 'ativo',
    color: 'amber',
    phases: [
      { name: 'Diagnóstico', durationWeeks: 2, description: 'Avaliação completa de composição corporal e definição de protocolo.' },
      { name: 'Recomposição Ativa', durationWeeks: 10, description: 'Ciclagem calórica, treino periodizado e check-ins quinzenais.' },
      { name: 'Estabilização', durationWeeks: 2, description: 'Consolidação dos resultados e plano de manutenção.' },
    ],
    includedServices: [
      { label: 'Consultas médicas', quantity: 5, unit: 'sessões' },
  ...
  },
  {
    ...
    programType: 'saude_metabolica',
    objective: 'Controle de síndrome metabólica, resistência à insulina e dislipidemia com abordagem multidisciplinar e exames periódicos.',
    durationWeeks: 13,
    status: 'ativo',
    color: 'blue',
    phases: [
      { name: 'Investigação', durationWeeks: 3, description: 'Painel laboratorial completo, avaliação de risco cardiovascular e definição de metas.' },
      { name: 'Intervenção', durationWeeks: 7, description: 'Protocolo medicamentoso, plano alimentar terapêutico e monitoramento de marcadores.' },
      { name: 'Reavaliação', durationWeeks: 3, description: 'Exames de controle, ajuste de tratamento e planejamento de manutenção.' },
    ],
    includedServices: [
      { label: 'Consultas médicas', quantity: 6, unit: 'sessões' },
      { label: 'Sessões de nutrição', quantity: 4, unit: 'sessões' },
  ...
  },
  {
    ...
    programType: 'longevidade',
    objective: 'Promoção de saúde a longo prazo, prevenção de doenças crônicas e otimização de biomarcadores de envelhecimento saudável.',
    durationWeeks: 24,
    status: 'ativo',
    color: 'emerald',
    phases: [
      { name: 'Mapeamento', durationWeeks: 4, description: 'Avaliação genômica, painel de longevidade e diagnóstico de risco.' },
      { name: 'Otimização', durationWeeks: 16, description: 'Intervenções personalizadas em nutrição, sono, estresse e atividade física.' },
      { name: 'Manutenção', durationWeeks: 4, description: 'Consolidação de hábitos, reavaliação de biomarcadores e plano de longo prazo.' },
    ],
    includedServices: [
