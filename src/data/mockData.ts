...
export const mockNutritionPlanJuliana: PatientNutritionPlanSummary = {
  ...
  mealAdherence: [
    ...
    { week: 4, label: 'Sem 4', adherencePercent: 74, mealsLogged: 31, mealsTotal: 42 },
  ] as MealAdherenceEntry[],
  mealPhotos: [
    {
      id: 'photo-001',
      mealName: 'Almoço',
