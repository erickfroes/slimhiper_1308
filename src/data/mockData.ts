...
export const mockReportDefinitions: PatientReportDefinition[] = [
{
  ...
  description:
  'Visão geral do histórico clínico, diagnósticos, evoluções e indicadores de saúde do paciente.',
  iconKey: 'FileText',
  badge: 'Atualizado',
...
},
{
  ...
  description:
  'Consolidado de valores contratados, pagos, em aberto e parcelas futuras do paciente.',
  iconKey: 'DollarSign',
  badge: 'Disponível',
...
},
{
  ...
  description:
  'Lista detalhada de todos os serviços utilizados, datas, profissionais e status de cada atendimento.',
  iconKey: 'ShoppingBag',
  exportImplemented: false
},
{
  ...
  description:
  'Relação de prescrições, atestados, laudos e demais documentos gerados para o paciente.',
  iconKey: 'FileCheck',
  exportImplemented: false
},
{
  ...
  description:
  'Índice de adesão ao plano alimentar, check-ins realizados, metas atingidas e tendências.',
  iconKey: 'Target',
  badge: 'Novo',
...
},
{
  ...
  description:
  'Linha do tempo completa com todos os eventos clínicos, financeiros e de comunicação do paciente.',
  iconKey: 'Clock',
  exportImplemented: false
},
{
  ...
  label: 'Alertas',
  description:
  'Resumo de alertas ativos, pendências clínicas, vencimentos e notificações relevantes do paciente.',
  iconKey: 'Bell',
  badge: '3 ativos',
...
export const mockAlertsJuliana: PatientAlert[] = [
{
  ...
  description:
  'Paciente registrou adesão de 68% na semana 3. Recomenda-se contato para reforço motivacional.',
...
},
{
  ...
  description:
  'Subjetivo: Relata dificuldade com dieta nos fins de semana. Objetivo: Peso 83,5 kg. Avaliação: Progresso moderado. Plano: Reforço motivacional.',
  date: '2026-04-28',
  professional: 'Dra. Fernanda Lima',
  category: 'clinical',
  actorName: 'Dra. Fernanda Lima',
...
},
{
  ...
  description:
  'Contrato do programa Emagrecimento 12 Semanas confirmado. Valor total: R$ 3.600,00 em 9x.',
  date: '2026-04-09',
  professional: 'Coord. Ana Souza',
  category: 'commercial',
  actorName: 'Coord. Ana Souza',
...
},
{
  ...
  description:
  'Pacote adquirido: 6 consultas médicas + 4 sessões de nutrição. Valor: R$ 3.600,00.',
  date: '2026-04-08',
  professional: 'Coord. Ana Souza',
  category: 'commercial',
  actorName: 'Coord. Ana Souza',
...
},
{
  ...
  description:
  'Juliana Pereira convertida após consulta de avaliação inicial. Origem: indicação.',
  date: '2026-04-07',
  professional: 'Coord. Ana Souza',
  category: 'commercial',
  actorName: 'Coord. Ana Souza',
...
// ─── Orientações Gerais ──────────────────────────────────────────────────
{
  ...
  isActive: true,
  notes:
  'Caminhada 30 min/dia, 5x por semana. Evitar exercícios de alta intensidade nas primeiras 4 semanas.',
...
export const mockNutritionPlanJuliana: PatientNutritionPlanSummary = {
  ...
  teamNotes: [
  {
    ...
    content:
    'Paciente relata dificuldade em manter o plano nos fins de semana. Orientada sobre estratégias de flexibilização controlada. Próxima sessão: revisar refeições de sábado e domingo.',
  ...
  },
  {
    ...
    authorRole: 'Médica',
    content:
    'Ajuste calórico aprovado. Manter proteína elevada para preservação de massa magra durante o déficit.',
    createdAt: '2026-04-24',
    isInternal: true
  }] as
  NutritionTeamNote[]
...
{ id: 'patient-010', name: 'Thiago Carvalho', issue: '4 alertas ativos', severity: 'critico' },
{
  id: 'patient-007',
  name: 'Larissa Martins',
  issue: 'Inadimplente · fatura vencida',
  severity: 'alto'
},
{
  id: 'patient-001',
  name: 'Juliana Pereira',
  issue: 'Adesão caiu para 68% (sem 3)',
  severity: 'medio'
}];


// ─── CLINIC PROGRAMS / PACKAGE TEMPLATES ─────────────────────────────────────

export const mockClinicPrograms: ClinicProgram[] = [
{
  id: 'prog-001',
  name: 'Emagrecimento 12 Semanas',
  programType: 'emagrecimento',
  objective:
  'Redução de gordura corporal com preservação de massa magra, reeducação alimentar e mudança de hábitos sustentável.',
  durationWeeks: 12,
  status: 'ativo',
  color: 'teal',
  phases: [
  {
    name: 'Adaptação',
    durationWeeks: 2,
    description: 'Avaliação inicial, anamnese completa e ajuste metabólico.'
  },
  {
    name: 'Aceleração',
    durationWeeks: 6,
    description:
    'Déficit calórico progressivo, bioimpedância quinzenal e plano alimentar ativo.'
  },
  {
    name: 'Consolidação',
    durationWeeks: 4,
...
},
{
  ...
  programType: 'hipertrofia',
  objective:
  'Ganho de massa muscular com acompanhamento médico e nutricional especializado, periodização e suplementação orientada.',
  durationWeeks: 16,
  status: 'ativo',
  color: 'violet',
  phases: [
  {
    name: 'Base',
    durationWeeks: 4,
    description: 'Avaliação de composição corporal, definição de metas e ajuste calórico.'
  },
  {
    name: 'Volume',
    durationWeeks: 8,
    description:
    'Superávit calórico controlado, acompanhamento de força e bioimpedância mensal.'
  },
  {
    name: 'Definição',
    durationWeeks: 4,
...
},
{
  ...
  programType: 'recomposicao',
  objective:
  'Redução simultânea de gordura e ganho de massa magra com protocolo individualizado de nutrição e acompanhamento clínico.',
  durationWeeks: 14,
  status: 'ativo',
  color: 'amber',
  phases: [
  {
    name: 'Diagnóstico',
    durationWeeks: 2,
    description: 'Avaliação completa de composição corporal e definição de protocolo.'
  },
  {
    name: 'Recomposição Ativa',
    durationWeeks: 10,
    description: 'Ciclagem calórica, treino periodizado e check-ins quinzenais.'
  },
  {
    name: 'Estabilização',
    durationWeeks: 2,
...
{
  id: 'prog-004',
  name: 'Saúde Metabólica 90 Dias',
  programType: 'saude_metabolica',
  objective:
  'Controle de síndrome metabólica, resistência à insulina e dislipidemia com abordagem multidisciplinar e exames periódicos.',
  durationWeeks: 13,
  status: 'ativo',
  color: 'blue',
  phases: [
  {
    ...
    durationWeeks: 3,
    description:
    'Painel laboratorial completo, avaliação de risco cardiovascular e definição de metas.'
  },
  {
    name: 'Intervenção',
    durationWeeks: 7,
    description:
    'Protocolo medicamentoso, plano alimentar terapêutico e monitoramento de marcadores.'
  },
  {
    name: 'Reavaliação',
    durationWeeks: 3,
...
{
  id: 'prog-005',
  name: 'Longevidade Preventiva',
  programType: 'longevidade',
  objective:
  'Promoção de saúde a longo prazo, prevenção de doenças crônicas e otimização de biomarcadores de envelhecimento saudável.',
  durationWeeks: 24,
  status: 'ativo',
  color: 'emerald',
  phases: [
  {
    name: 'Mapeamento',
    durationWeeks: 4,
    description: 'Avaliação genômica, painel de longevidade e diagnóstico de risco.'
  },
  {
    name: 'Otimização',
    durationWeeks: 16,
    description: 'Intervenções personalizadas em nutrição, sono, estresse e atividade física.'
  },
  {
    name: 'Manutenção',
    durationWeeks: 4,
  ...
  { label: 'Contrato de prestação de serviços', required: true },
  { label: 'Termo de consentimento informado', required: true },
  { label: 'Anamnese clínica completa', required: true },
  { label: 'Exames pré-tratamento', required: true },
