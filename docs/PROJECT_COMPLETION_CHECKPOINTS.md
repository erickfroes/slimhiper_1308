...
| Fase 9 - CRM/estoque               | PR 9.2 implementada                    | Pre-requisitos revisados: Fase 8 possui migrations 180-183 para relatorios/chat/portal/comunicacoes; PR 9.1 entregou `20260601190000_190_crm_inventory_contracts.sql` com fundacao CRM/estoque, RBAC granular, RLS/grants e RPCs auditadas. PR 9.2 adiciona `20260601203000_191_crm_leads_pipeline_operations.sql` com detalhe de lead, tarefas, notificacoes CRM e conversao idempotente lead -> paciente com consentimento, deduplicacao, timeline, audit log e consulta inicial opcional; `crmApi` real/mock-gated e `/clinic/crm` operacional com funil, filtros, detalhe, atividades, tarefas e conversao. Validacao Supabase local/migration up segue pendente porque a tarefa nao autorizou executar migrations locais mutantes; checks Next/TS/lint/build passaram. |
