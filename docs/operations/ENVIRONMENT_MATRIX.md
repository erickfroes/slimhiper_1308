...
- Nunca reutilizar service role, tokens de webhook, chaves D4Sign/Asaas ou
...
| `NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY` | Vazio/dummy | Vazio/dummy | Sandbox | Production se usado | Publica; nao substitui Asaas backend. |
